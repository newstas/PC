...
- OEM (производитель оригинального оборудования) — привязана к оборудованию того компьютера, на котором она установлена, нельзя переустановить на другой компьютер.

**Программа ShowKeyPlus**

[Скачать ShowKeyPlus](https://github.com/superfly-inc/showkeyplus/releases)
