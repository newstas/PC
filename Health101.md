...
Например: покажет `Частичный ключ продукта: 3V66T`, как видим, в системе уже есть ключ (3V66T), а точнее:
-
   1. VK7JG-NPHTM-C97JM-9MPGT-3V66T для редакции Pro,
   2. YTMG3-N6DKC-DKB77-7M9GH-8HVX7 для редакции Home,
   3. BT79Q-G7N6G-PGBYW-4YWX6-6F4BT для Home SL.
